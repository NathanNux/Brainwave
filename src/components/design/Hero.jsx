...
// background circles will use native react parallax
...
// parallax by react works in a way, that you set up the streng of the parallax and the ref so it knows where to apply the parallax effect and can be passed to other components.
// then you crete the component you want to move in MouseParallax and then you can just passed it to use effect in other components and it will work